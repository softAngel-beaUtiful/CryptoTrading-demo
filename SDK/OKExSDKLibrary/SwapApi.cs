...
namespace OKExSDK
{
    ...
    {
        private string SWAP_SEGMENT = "api/swap/v5";
        ...
        /// <returns></returns>
        public async Task<JObject> makeOrderAsync(string instrument_id, string type, decimal price, string size, string client_oid, string match_price)
        {
